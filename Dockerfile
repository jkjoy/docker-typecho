...
#Install nginx php-fpm php-pdo unzip curl  php7.4-sqlite
...
RUN apt update && apt -y install php7.4 php7.4-fpm php7.4-zip  apt-utils php7.4-curl php7.4-gd php7.4-intl php-pear php7.4-imagick php7.4-imap php7.4-mcrypt php7.4-ps php7.4-pspell sqlite3-dev php7.4-tidy php7.4-xmlrpc php7.4-xsl php7.4-mbstring git 
